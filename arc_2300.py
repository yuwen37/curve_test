...
img_path = './image_png/DSC00313.png'  # 1200万像素
...
# np.savetxt('./figure/arc2300_x.txt', x, fmt='%d')
# np.savetxt('./figure/arc2300_y.txt', y, fmt='%d')
plt.figure(3)
origin = cv2.imread('./images/DSC00313.JPG')
plt.imshow(origin)
plt.plot(x, y, color='blue', marker='o',  linewidth=0.5, markersize=5)
plt.show()
# plt.savefig('./figure/arc2300.png', dpi=1080)
plt.close(3)
