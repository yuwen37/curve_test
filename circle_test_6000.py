...
img_path = './images/DSC00318.JPG'  # 5400万像素
# img_path = './image_png/DSC00318.png'  # 5400万像素
...
plt.figure(3)
origin = cv2.imread('./images/DSC00318.JPG')
plt.imshow(origin)
...
plt.plot(s, K)
plt.title('4次多项式拟合下半径为1的半圆曲率识别结果')
